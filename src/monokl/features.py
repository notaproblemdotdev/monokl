"""Feature flags for monokl.

Provides decorators to mark commands as requiring specific feature flags.

Usage:
    from monokl.features import experimental, feature_flag
...
Configuration:
    ...
    Environment:
        MONOKL_FEATURE_EXPERIMENTAL=true
"""
...
FEATURE_FLAG_ATTR = "__monokl_feature_flag__"
